...
//added 
  // onSearchChange argument
  //entire handleChange function
  //moved input into object and adding 
...
// you'll need to use that state value to determine which items are being displayed on the page, similar to how the category dropdown works.
...
// Well, the <select> input should probably be controlled as well! The tests don't require it, but feel free to update the <select> element to be a controlled element.